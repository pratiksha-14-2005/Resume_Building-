          ...
          {form.certifications.map((row, i) => (
            <div key={`ce-${i}`} className="repeat-block">
              ...
              <div className="grid-2">
                ...
                <label className="label">
                  Issue date
                  <input className="input" value={row.issueDate} onChange={(e) => patchItem('certifications', i, 'issueDate', e.target.value)} />
                </label>
                <label className="label">
                  Expiry date
                  <input className="input" value={row.expiryDate} onChange={(e) => patchItem('certifications', i, 'expiryDate', e.target.value)} />
                </label>
              </div>
            </div>
          ))}
        ...
        <fieldset className="card fieldset">
          ...
          {form.projects.map((row, i) => (
            <div key={`pr-${i}`} className="repeat-block">
              ...
              <label className="label">
                Name
                <input className="input" value={row.name} onChange={(e) => patchItem('projects', i, 'name', e.target.value)} />
              </label>
              <label className="label">
                Description
                <textarea
              ...
              <div className="grid-2">
                <label className="label">
                  Link
                  <input className="input" type="url" value={row.link} onChange={(e) => patchItem('projects', i, 'link', e.target.value)} />
                </label>
                <label className="label">
                  Tech stack
                  <input className="input" value={row.techStack} onChange={(e) => patchItem('projects', i, 'techStack', e.target.value)} />
                </label>
              </div>
            </div>
          ))}
          ...
          {form.internships.map((row, i) => (
            <div key={`in-${i}`} className="repeat-block">
              ...
              <div className="grid-2">
                <label className="label">
                  Company / org
                  <input className="input" value={row.company} onChange={(e) => patchItem('internships', i, 'company', e.target.value)} />
                </label>
                <label className="label">
                  Role
                  <input className="input" value={row.role} onChange={(e) => patchItem('internships', i, 'role', e.target.value)} />
                </label>
                <label className="label">
                  Duration
                  <input className="input" value={row.duration} onChange={(e) => patchItem('internships', i, 'duration', e.target.value)} />
                </label>
              </div>
              <label className="label">
                Description
